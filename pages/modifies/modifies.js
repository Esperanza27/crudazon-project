          ...
          <div class="card shadow-sm h-100 justify-content-center">
              <form id="my-form" onsubmit="onSubmit(event)">      
                  ...
                  <div class="d-flex justify-content-evenly mb-3 mt-1 ">
                      <button type="submit" class="btn btn-secondary " style="width:80px">${mode}</button>
                      <button type="button" class="btn btn-secondary " onclick="onReset()" style="width:80px">Reset</button>
                      <button type="button" class="btn btn-secondary" style="width:80px"><a class="text-decoration-none text-white" href="../home/home.html">Close</a>
                      </button>
                  </div>
